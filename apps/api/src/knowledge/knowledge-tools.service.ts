...
- list_notes (BROWSE): when the user asks what they've saved or to browse notes ("what notes do I have on faith", "list my articles"), call it, optionally filtered by folder or tag.
